									...
									[
										...
										},
										{
    										...
    										onClick: function(){
       											...
       											if(
												   this.getDialog().getContentElement('info','width').getValue() == ""
												   &&
												   this.getDialog().getContentElement('info','height').getValue() == "" 
												){
       												this.getDialog().getContentElement('info','width').setValue(425);
       												this.getDialog().getContentElement('info','height').setValue(355);
       											}
    										},
											align : 'center'
										}
