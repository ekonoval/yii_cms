...
require __DIR__ . "/../../../config/ckfinder.php"; // !!!!!!!!!!
...
function CheckAuthentication()
{
    ...
    return CkFinderConfig::isBackendUserSignedIn();
}
...
$baseUrl = CkFinderConfig::getBaseUrl();
...
//$baseDir = resolveUrl($baseUrl);//todo
//$baseDir = 'd:\denwer3\home\appyii.dev\www\images\ckeditor\\';
$baseDir = CkFinderConfig::getBaseDir();

//$baseUrl = "{$_SERVER["DOCUMENT_ROOT"]}/ck/ckfinder/userfiles/";
//echo "<h2>Вася </h2>";
